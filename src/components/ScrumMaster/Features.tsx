...
const Features = ()=>{
    return(
        <div className=" py-8">
          ...
          DATA ANALYTICS certification training program
          </h5>
          <h2
        ...
        <div className="grid_item border_r">
            ...
            <p className="fs-medium pt-3">We Provide Lifetime access to our library(online) which has presentations, questionnaires, installation guide & session recordings.</p>
        </div>
        ...
        <div className="text-center mt-5">
            ...
            <Link href="" className="button-def button-3 me-3 mt-4 mb-3 fs-4"><span>Get Started Now</span></Link>
            </div>
