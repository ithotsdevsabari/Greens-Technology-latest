  ...
  return (
        ...
        <section className="mb-8 py-6">
          <div className="container">
            ...
            <div className="mb-5">            
                <h2 className="text-uppercase text-center fs-20 mb-1 text-green">Data Analytics Certification Training Program</h2>
                <h2 className="text-center fs-5">
                    <span className="d-block text-grad mb-1">Course Fee </span> 
            ...
            <div className="course-fee box-shadow2 mb-5 p-0">
                <div className="row"> 
                    ...
                    <div className="col-lg-4">
                        <div className="mt-5 fs-medium px-3 pb-lg-0">
                            <div className="top_banner_list">
                                <ul>                        
                                    ...
                                    <h3 className="text-decoration-line-through fs-1 d-inline-block mt-3 ms-3 mb-0 text-gray-light-more line-1">AUD $ 15,000</h3>
                                    </li>                                    
                                </ul>
                                <h2 className="fs-5 mb-3 text-center text-lg-start">
                                    <span className="d-block text-grad mb-2 ">AUD $ 10,000/-</span>                                 
                                </h2>
                    ...
                    <div className="col-lg-4">
                        <div className="mt-5 fs-medium pb-5">
            ...
            <div className="course-fee box-shadow2 p-4 p-lg-5">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <div className="mt-lg-3 fs-medium">
                            <div className="top_banner_list">
                            <ul className="mb-0">                              
                                <li className="d-block mb-4 fw-semibold">
                                    <Image src={tickIcon} alt="moon" className="ms-auto me-3" width={24} height={24} />
