...
import training from "../../../public/img/scrum/scrum_master.webp";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">
                                <Link href="" className="ps-2 text-black fs-4-0"> Scrum Master Course Training</Link></li>
                        </ol>
                    </nav> 
                  </div>
                </div>
            ...
            <div className="pt-1 pb-3">
              <div className="container bg-white rounded-7">                
                ...
                <div className="row">
                  ...
                  <div className="col-lg-7 col-xl-7 bg-white rounded-7 ps-3 ps-xl-4  ps-xxl-5"> 
      ...
      <g>
        ...
        />
                      ...
                      <h2 className="fs-30 mb-1">
                        Your Path to Becoming a Certified Scrum Master Starts Here
                      </h2>
                      ...
                      <div className="main-banner-content fs-medium">
                        <div className="top_banner_list2">
                          <ul>                            
                            ...
                            <Link href="#ScrumMasterSyllabus" className="text-banner">
                              <svg
                                        height="24px"
                                        id="Layer_1"
                                        viewBox="0 0 24 24"
                              ...
                              Scrum Master <span className="text-green-mid ps-2"> $595</span>
                              </Link>
                              </li>
                      ...
                      <div className="">
                          {/* <p>Master Course Price at: <span className="text-green-mid">$595</span> for excluding GST</p> */}
                            <Link href="#" className="button-def button-3 me-lg-3" onClick={handleOpenOverlay}><span>Apply Now</span></Link>
                            <Link href="#scrumMasterBatchDetails" className="button-def button-3-white"><span>View Schedule</span></Link>
                      </div>

                    </div>
                  </div>

                  <div className="col-lg-5 col-xl-5 pe-lg-0">
                    <div className="text-center scrum_banner_img mb-3 mb-lg-0">
                      <Image src={training} alt="add" className="ms-auto w-max" />
                    </div>
                  </div>
                                ...
                                <ul className="ps-0">
                                    <li className="d-block">
                                      <div className="mb-3">
                                        ...
                                        <h2 className="d-block mt-2 fs-4">Hands on Training Project</h2>
                                      </div>                                                                
                                    </li>
                                </ul>
                            </div>                   
