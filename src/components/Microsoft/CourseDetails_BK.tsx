          ...
          <div className="container"> 
            ...
            <div className="mb-5">  
                <h2 className="text-center fs-5">
                    <span className="d-block text-dark mb-1">Microsoft 365 Course Syllabus </span> 
                </h2>
            </div>

            
            <div className="course-box shadow-box mb-5 py-5">
                <div className="row"> 
            ...
            <div className="course-box shadow-box mb-5 py-5">
                <div className="row"> 
                    <h2 className="text-uppercase text-center fs-4 mb-1">Microsoft 365</h2> 
                    <h2 className="text-center fs-5"> 
                        <span className="d-block text-grad mb-2"> 8. Microsoft Word Syllabus</span> 
                    </h2>                    
                </div>
                <div className="row">
                    <div className="col-lg-4">
                            ...
                            <div className="mt-1 fs-medium">
                                <div className="top_banner_list">
                                        ...
                                        <ul className="d-block mb-2 ms-4 mt-2">
                                            ...
                                            <span className="position-absolute">
                                                    2. </span>
                                                <span className="ms-4">Understanding Word Interfaces: Ribbon, Quick Access Toolbar</span>                                            
                                            
                                            </li>
                                            <li className="d-block mb-2 mt-2">     
                                            <span className="position-absolute">
                                                    3. </span>
                                                <span className="ms-4">Creating, Opening, Saving, Zooming & Navigating Documents</span>                                              
                                            ...
                                            <span className="position-absolute">
                                                    4. </span>
                                                <span className="ms-4">Using Templates & Themes</span>                                                
                                            ...
                                            <span className="position-absolute">
                                                    5. </span>
                                                <span className="ms-4">Formatting Text: Font, Size, Color, Styles</span>   
                                            </li>  

                                            <li className="d-block mb-2 mt-2">    
                                            <span className="position-absolute">
                                                    6. </span>
                                                <span className="ms-4">Applying Text Effects: Bold, Italic, Underline</span>                                              
                                            </li> 
                            ...
                            <div className="mt-1 fs-medium">
                                <div className="top_banner_list">
                                        ...
                                        <ul className="d-block mb-2 ms-4 mt-2">    
                                            ...
                                            <span className="position-absolute">
                                                    7. </span>
                                                <span className="ms-4">Aligning Text: Left, Center, Right, Justified</span>                                                  
                                            ...
                                            <span className="position-absolute">
                                                    8. </span>
                                                <span className="ms-4"> Changing Paragraph spacing & indentation</span>                                                
                                            ...
                                            <span className="position-absolute">
                                                    9. </span>
                                                <span className="ms-4">Using Bullets & Numbering</span>                                                 
                                            ...
                                            <span className="position-absolute">
                                                    10. </span>
                                                <span className="ms-4">Setting up Page Margins, Orientation, Inserting Special Characters & Symbols</span>                                             
                                            ...
                                            <span className="position-absolute">
                                                    11. </span>
                                                <span className="ms-4">Inserting & Formatting images, shapes, icons</span>                                                
                            ...
                            <div className="mt-1 fs-medium">
                                <div className="top_banner_list">
                                        ...
                                        <ul className="d-block mb-2 ms-4 mt-2">
                                            ...
                                            <span className="position-absolute">
                                                    13. </span>
                                                <span className="ms-4">Creating Mail merge Documents, Compressing File, Converting compressed file to pdf or document</span>                                               
                                            ...
                                            <span className="position-absolute">
                                                   14. </span>
                                                <span className="ms-4">Previewing & Printing Documents</span>                                               
                                            ...
                                            <span className="position-absolute">
                                                    15. </span>
                                                <span className="ms-4">Saving & Exporting documents in different formats: PDF, HTML, Plain Text</span>                                          
                                            ...
                                            <span className="position-absolute">
                                                    16. </span>
                                                <span className="ms-4">Auto Correcting</span>                                               
                                            ...
                                            <span className="position-absolute">
                                                    17. </span>
                                                <span className="ms-4">Creating Password for Documents</span>                                                
            ...
            <div className="course-box shadow-box mb-5 py-5">
                <div className="row"> 
                    <h2 className="text-uppercase text-center fs-4 mb-1">Microsoft 365</h2> 
                    <h2 className="text-center fs-5"> 
                        <span className="d-block text-grad mb-2">  9. Microsoft Excel Syllabus </span> 
                    </h2>                    
                </div>
                                ...
                                <div className="top_banner_list">
                                    ...
                                    <ul className="d-block mb-2 ms-4 mt-2">
                                        ...
                                        <ul className="d-block mb-2 ms-4 mt-2">
                                            ...
                                            <span className="position-absolute">
                                                    4. </span>
                                                <span className="ms-4">Creating, opening, and saving workbooks </span>                                               
                                            ...
                                            <li className="d-block mb-2 mt-2">    
                                                <span className="position-absolute">
                                                    5. </span>
                                                <span className="ms-4">Formatting cells, rows, and columns </span>                                             
                                            ...
                                            <li className="d-block mb-2 mt-2">    
                                                <span className="position-absolute">
                                                    6. </span>
                                                <span className="ms-4"> Introduction to basic formulas and functions (SUM, AVERAGE, MAX, MIN) </span>                                           
                                            </li>  
                            ...
                            <div className="mt-1 fs-medium">
                                <div className="top_banner_list">
                                        ...
                                        <li className="d-block mb-2 mt-2">     
                                            <span className="position-absolute">
                                                    7. </span>
                                                <span className="ms-4">Importing data into Excel from different sources (CSV files, databases, etc.) </span>                                            
                                            ...
                                            <span className="position-absolute">
                                                    8. </span>
                                                <span className="ms-4">Sorting and filtering data </span>                                            
                                            ...
                                            <span className="position-absolute">
                                                    9. </span>
                                                <span className="ms-4">Using data validation for accurate data entry </span>                                              
                                            ...
                                            <span className="position-absolute">
                                                    10. </span>
                                                <span className="ms-4">Introduction to conditional formatting for visual data analysis </span>                                               
                                            ...
                                            <span className="position-absolute">
                                                    11. </span>
                                                <span className="ms-4">Setting up an inventory tracking system using Excel </span>                                               
                                            ...
                                            <span className="position-absolute">
                                                    12. </span>
                                                <span className="ms-4">Creating Pivot Tables & Charts </span>                                              
                                            ...
                                            <span className="position-absolute">
                                                    13. </span>
                                                <span className="ms-4">Page Layout, Formulas  </span>   
                                            </li>                                       
                                            <li className="d-block mb-2 mt-2"> 
                                            <span className="position-absolute">
                                                    14. </span>
                                                <span className="ms-4">Printing & Managing Workbook </span> 
                                            </li> 
                                            <li className="d-block mb-2 mt-2">    
                                            <span className="position-absolute">
                                                    15. </span>
                                                <span className="ms-4">Search & Replace </span> 
                                            </li>                                       
                            ...
                            <div className="mt-1 fs-medium">
                                <div className="top_banner_list">
                                        ...
                                        <ul className="d-block mb-2 ms-4 mt-2">
                                            ...
                                            <span className="position-absolute">
                                                    16. </span>
                                                <span className="ms-4">The Spelling Dialog Box </span>                                                
                                            
                                            </li> 
                                            <li className="d-block mb-2 mt-2">   
                                            <span className="position-absolute">
                                                    17. </span>
                                                <span className="ms-4">Deleting Row, Columns, Excel sheet, Workbook, Cell Contents </span>                                              
                                            
                                            </li> 
                                            <li className="d-block mb-2 mt-2">    
                                            <span className="position-absolute">
                                                    18. </span>
                                                <span className="ms-4">Creating Password for Workbook </span>                                             
                                            
                                            </li>                                       
                                            <li className="d-block mb-2 mt-2">    
                                            <span className="position-absolute">
                                                    19. </span>
                                                <span className="ms-4">Attaching Excel file to Mail </span>                                             
                                            
                                            </li> 
                                            <li className="d-block mb-2 mt-2">    
                                            <span className="position-absolute">
                                                    20. </span>
                                                <span className="ms-4">Automating Repetitive Tasks with macros (Basic Introduction)</span>                                             
                                            
                                            </li> 
                                            <li className="d-block mb-2 mt-2">   
                                            <span className="position-absolute">
                                                    21. </span>
                                                <span className="ms-4">Project:  Setting up an inventory tracking system using Excel</span>                                              
