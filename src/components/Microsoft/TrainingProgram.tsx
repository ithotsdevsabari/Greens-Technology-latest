        ...
        <div>
            <div className="train_bg py-10 banner-gradient2">
                <div className="container">
                    ...
                    <h2
            className=" fs-5-0 mb-2 text-grad fw-semibold text-center">Related Certification Training Program</h2>
            <div className="row border_b_line py-4">

                <div className="col-4 col-lg-3 col-xl-2 pl-0">
                ...
                <div className="col-8 col-lg-9 col-xl-10 pl-lg-0">
                    <div className="row">
                        <div className="col-lg-3 pl-lg-0">
                            <div className="training_con">                        
                                <div className="ds_cont">
                                    <h3 className="fs-4">Data Science</h3>
                ...
                <div className="col-8 col-lg-9 col-xl-10 pl-lg-0">
                    <div className="row">
                        <div className="col-lg-3 pl-lg-0">
                            <div className="training_con">                        
                                <div className="ds_cont">
                                <h3 className="fs-4">Internet of Things (IoT)</h3>
                                    <p className=""><span>44,856</span> ENROLLED LEARNERS</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="text-center mt-5">
                ...
                <Link href="" className="button-def button-3 me-3 mt-4 mb-3 fs-4"><span>Show More</span></Link>
            </div>
