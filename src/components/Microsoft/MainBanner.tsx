                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">
                                <Link href="" className="ps-2 text-black fs-4-0"> Microsoft 365 Course Training</Link></li>
                        </ol>
                    </nav> 
                  </div>
                </div>
...
{/* left content end */}
                  ...
                  <div className="col-lg-5 col-xl-5 pe-lg-0">
                    <div className="text-center microsoft365_banner_img mb-3 mb-lg-0">
                                ...
                                <ul className="ps-0">
                                    <li className="d-block">
                                      <div className="mb-3">
                                        ...
                                        <h2 className="d-block mt-2 fs-4">Skill Building Units</h2>
                                      </div>                                                                
                                    </li>
                                </ul>
                            </div>                   
                                ...
                                <ul className="ps-0">
                                    <li className="d-block">
                                      <div className="mb-3">
                                        ...
                                        <h2 className="d-block mt-2 fs-4"> Tips & Tricks </h2>
                                      </div>                                                                
                                    </li>
                                </ul>
                            </div>                   
