    ...
    <>
      <footer className="footer-area">
              ...
              >
                ...
                <ul className="get-in-touch">
                  ...
                  <li>
                    ...
                    <a href="mailto:hello@greenstechnology.com">hello@greenstechnology.com</a>
                    <a href="mailto:support@greenstechnology.com">support@greenstechnology.com</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="copyright-area">
          <div className="container">
            <p>
              Copyright &copy; {currentYear} greenstechnology. All Rights Reserved By{" "}
