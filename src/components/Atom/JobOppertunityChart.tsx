        ...
        <div className="">
               <div className="">
                <div className="container">
                    ...
                    Discover over {jobCount} exciting job opportunities for {graphCourseName} skills across Australia! <br/>
                    Join us and unleash your {graphCourseSkill} skills in a thriving job market.
                    </h2>
                    ...
                    <h2 className="fs-30 mt-5  text-center">"Experience interactive online classes with live instructors, 
                        where your questions are answered in real-time! <br/>Join our Online {courseName} courses in 
