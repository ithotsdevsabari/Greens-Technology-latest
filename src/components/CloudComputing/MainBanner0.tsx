                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-4 col-xl-4 col-xxl-3">
                            <p className="yellow-box px-2 px-xxl-2 w-100 text-center mb-3">
                              ...
                              <span className="ms-1 d-inline-block text-white">Master Program</span> 
                            </p>
                          </div>
...
<svg
    ...
    <g>
      <g>
        ...
        />
                      ...
                      Your Path to Becoming a Certified Cloud Computing Professional
                      </h2>
                          ...
                          <ul>                            
                            <li className="d-block mb-2 d-flex justify-content-start">
                              <svg
                                ...
                                Data Engineering Aws <span className="text-green-mid ps-2"> $795</span></li>
  ...
  Data Engineering Azure  <span className="text-green-mid ps-2"> $795</span></li>
  ...
  Data Engineering GCP <span className="text-green-mid ps-2"> $795</span></li>
  ...
  DeVops Engineering <span className="text-green-mid ps-2"> $795</span></li>
  ...
  AWS Cloud Engineering  <span className="text-green-mid ps-2"> $595</span></li>
  ...
  Azure Cloud Engineering <span className="text-green-mid ps-2"> $595</span></li>
  ...
  GCP Cloud Engineering  <span className="text-green-mid ps-2"> $595</span></li>
                      ...
                      <div className="">
                          <p>Master Course Price at: <span className="text-green-mid">$1995</span> for excluding GST</p>
