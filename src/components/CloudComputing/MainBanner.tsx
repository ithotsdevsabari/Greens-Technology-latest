...
import training from "../../../public/img/cloudcomputing/cloudcomputing.webp";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">
                                <Link href="" className="ps-2 text-black fs-4-0"> Cloud Computing Course Training</Link></li>
                        </ol>
                    </nav> 
                  </div>
                </div>
    ...
    <g>
      <g>
        ...
        />
                      ...
                      Your Path to Becoming a Certified Cloud Computing
                      </h2>
                        ...
                        <div className="top_banner_list2">
                          <ul>                            
                            <li className="d-block mb-2 d-flex justify-content-start">
                                <Link href="#CourseDataEngineeringAWS" className="text-banner" >
                                <svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
    ...
    <g>
      <g>
        ...
        />
                                ...
                                Data Engineering - AWS <span className="text-green-mid ps-2"> $795</span></Link>
                              
                                </li>
                            
                            <li className="d-block mb-2 d-flex justify-content-start">
                            <Link href="#CourseDataEngineeringAzure" className="text-banner" >
<svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
  ...
  Data Engineering - Azure  <span className="text-green-mid ps-2"> $795</span></Link></li>
                            
    <li className="d-block mb-2 d-flex justify-content-start">
    <Link href="#CourseDataEngineeringGCP" className="text-banner" >
      <svg
          height="24px"
          id="Layer_1"
          viewBox="0 0 24 24"
  ...
  Data Engineering - GCP <span className="text-green-mid ps-2"> $795</span></Link></li>

                            <li className="d-block mb-2 d-flex justify-content-start">   
                            <Link href="#CourseDevOpsEngineering" className="text-banner" >                           
                              <svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
  ...
  DevOps Engineering <span className="text-green-mid ps-2"> $795</span></Link></li>

                            <li className="d-block mb-2 d-flex justify-content-start">
                            <Link href="#CourseAWSCloudEngineering" className="text-banner" >
                              <svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
  ...
  AWS Cloud Engineering  <span className="text-green-mid ps-2"> $595</span></Link></li>

                            <li className="d-block mb-2 d-flex justify-content-start">
                            <Link href="#CourseAzureCloudEngineering" className="text-banner" >
                              <svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
  ...
  Azure Cloud Engineering <span className="text-green-mid ps-2"> $595</span></Link></li>

  <li className="d-block mb-2 d-flex justify-content-start">
  <Link href="#CourseGCPCloudEngineering" className="text-banner" >
                              <svg
    height="24px"
    id="Layer_1"
    viewBox="0 0 24 24"
  ...
  GCP Cloud Engineering  <span className="text-green-mid ps-2"> $595</span></Link></li>
                      ...
                      <div className="">
                          ...
                          <Link href="#viewCloudComputingCourse" className="button-def button-3-white"><span>View Schedule</span></Link>
                      </div>
                  ...
                  <div className="col-lg-5 col-xl-4 pe-lg-0">
                    <div className="text-center cloudcomputing-right mb-3 mb-lg-0">
