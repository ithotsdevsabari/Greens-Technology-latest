        ...
        <div className="">
               <div className="">
                <div className="container">
                    ...
                    Join us and unleash your Data Analytical skills in a thriving job market.
                    </h2>
                    ...
                    <h2 className="fs-30 mt-5  text-center">"Experience interactive online classes with live instructors, where your questions are answered in real-time! <br/>Join our Online Data Analytics courses in Australia and transform your skills today!"
          </h2> 
                    </div>
                </div>
                </div> 
