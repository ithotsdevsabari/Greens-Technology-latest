...
import training from "../../../../public/img/banner1.png";
import practice from "../../../../public/img/practice.png";
import lifeTime from "../../../../public/img/lifetime.png";
import support from "../../../../public/img/247.png";
import googleCloud from "../../../../public/img/google_cloud.jpg";
import Cloud from "../../../../public/img/cloud.webp";
import defender from "../../../../public/img/defender.png";
import window from "../../../../public/img/window.png";
import region from "../../../../public/img/region.png";
import ideas from "../../../../public/img/ideas.png";
import story from "../../../../public/img/story.png";
import tra from "../../../../public/img/training2.png";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">
                                <Link href="" className="ps-2 text-black fs-4-0"> Google Cloud Platform Certification Training</Link></li>
                        </ol>
                    </nav> 
                  </div>
                </div>
                      ...
                      <div className="main-banner-content fs-medium">
                        <div className="top_banner_list">
                          <ul>                        
                            ...
                            <li className="d-block mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="yellowText" fill="none" height="24" viewBox="0 0 24 24" width="24"><path d="M10.5858 13.4142L7.75735 10.5858L6.34314 12L10.5858 16.2427L17.6568 9.1716L16.2426 7.75739L10.5858 13.4142Z" fill="currentColor"/></svg>
                            Learn from leading industry experts.</li>

                            <li className="d-block mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="yellowText" fill="none" height="24" viewBox="0 0 24 24" width="24"><path d="M10.5858 13.4142L7.75735 10.5858L6.34314 12L10.5858 16.2427L17.6568 9.1716L16.2426 7.75739L10.5858 13.4142Z" fill="currentColor"/></svg>
                            Practical exercises to supplement theoretical learning</li>

                            <li className="d-block mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="yellowText" fill="none" height="24" viewBox="0 0 24 24" width="24"><path d="M10.5858 13.4142L7.75735 10.5858L6.34314 12L10.5858 16.2427L17.6568 9.1716L16.2426 7.75739L10.5858 13.4142Z" fill="currentColor"/></svg>
                            Learn in-depth concepts of Google Cloud Platform</li>
