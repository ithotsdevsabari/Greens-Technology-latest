                    ...
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">
                                <Link href="" className="ps-2 text-black fs-4-0"> About Us </Link></li>
                        </ol>
                    </nav> 
                  </div>
                </div>
            ...
            <div className="pt-1 pb-5">
              <div className="container bg-white rounded-7 overflow-hidden">                
                ...
                <div className="row">
                  ...
                  <div className="col-lg-7 bg-white rounded-7 ps-5 pt-5 pb-5">
                    <div className="main-banner-content">

                      <h1 className=" fs-5-0 mb-5 text-grad fw-semibold "
                        data-aos="fade-in"
                        data-aos-duration="1000"
                        data-aos-delay="200">
                            About Greens Technology Chennai
                      </h1>
                      ...
                      <h2 className=" fs-2 mb-5"
                        ...
                        data-aos-duration="1000"
                        data-aos-delay="200">
                           GREENS TECHNOLOGY AWARDED AS THE BEST IT TRAINING CENTER IN ADYAR, OMR, TAMBARAM, VELACHERY CHENNAI .
                      </h2>
